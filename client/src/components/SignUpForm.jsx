...
const SignUpForm = () => {
  ...
  //console.log(authUserFirstName,authUserLastName)
      ...
      <div>
        ...
        <div className="mt-1">
          <input
            ...
            className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-pink-500 focus:border-pink-500 sm:text-sm text-blue-500"
          />
        </div>
      </div>
